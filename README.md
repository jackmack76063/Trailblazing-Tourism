...
<p align="center">
  <img src="visuals/AlltrailsTree.jpg" width="500" alt="Decision tree visualizing trail count classification">
  <br>
  <img src="visuals/confusion_matrix.png" width="450" alt="Confusion matrix showing model accuracy">
</p>

The model correctly classified nearly every test case, with only one "Moderate Trails" country misclassified as "High Trails."
...
<p align="center">
  <img src="visuals/kmeans_k3_clustering.png" width="500" alt="K-Means clustering of trails by difficulty, length, and popularity">
</p>

At k=3, countries separate into three natural groups — casual/beginner hiking destinations, a moderate middle tier, and a small cluster of advanced, high-review outliers.

<p align="center">
  <img src="visuals/trails_per_million_tourists.png" width="600" alt="Bar chart of trails per million tourists by country">
</p>

Countries like Liechtenstein and Germany have far more trails relative to their tourist volume — suggesting hiking is a core driver of visits there, unlike higher-traffic destinations like the US or UK where hiking is one draw among many.
